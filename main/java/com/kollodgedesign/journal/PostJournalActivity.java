...
public class PostJournalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveJournal() {
        ...
        imageURI != null) {
            ...
            final StorageReference filepath = storageReference //..journal_images/ourimage.jpg
                    .child("journal_images").child("my_image" + Timestamp.now().getSeconds()); //my_image_88887777
